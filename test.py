...
LIST_URL = 'https://www.norbelbaby.com.tw/TinTin/ECproductShopAction.do?kind=A12&page=1'
...
def get_item_list():
    ...
    if list_req.status_code == requests.codes.ok:
        ...
        shop_links_a_tags = soup.find_all('div', class_="label_name")
        price_tags = soup.find_all('div', class_="label_price")
        shop_links = []
        price_links = []
        merge_links = []
