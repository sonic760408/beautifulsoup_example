...
base_url = "https://www.norbelbaby.com.tw"
output_csv = "tintin.csv"
...
def getinfo():
    ...
    productDivs = soup.find_all('div', attrs={'id': 'headNavBar'})
...
def getitems(url: str):
    ...
    productDivs = soup.find_all('div', attrs={'class': 'bigkind_content'})
    for div in productDivs:
        # print(div)
        prdt_name = div.find_all('div', attrs={'class': 'label_name'})
        prdt_price = div.find_all('div', attrs={'class': ['label_price', 'label_bound']})
        for p in prdt_name:
